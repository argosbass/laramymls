...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    if (start === end) {
        ...
        editor.loadHTML(fullText)
    } else {
        // 👉 Hay selección → limpiar solo el fragmento
        const selectedText = fullText.slice(start, end)

        // Borramos el contenido con formato
        editor.setSelectedRange([start, end])
        editor.insertString('') // elimina lo seleccionado

        // Volvemos a insertar ese texto pero sin formato
